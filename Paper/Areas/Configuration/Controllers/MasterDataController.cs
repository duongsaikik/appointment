...
using OfficeOpenXml;
using Paper.Areas.Configuration.Models;
...
namespace Paper.Areas.Configuration.Controllers
{
    ...
    public class MasterDataController : BaseController
        ...
        public async Task<IActionResult> MasterKeys()
        {
            ...
            var masterKeysViewModel = _mapper.Map <List<MasterDataKeyy>,List<MasterDataKeyViewModel>>(masterKeys);
        ...
        public async Task<IActionResult> MasterKeys(MasterKeysViewModel masterKeyss)
        {
            ...
            var masterKey = _mapper.Map<MasterDataKeyViewModel, MasterDataKeyy>(masterKeyss.MasterKeyInContext);
        ...
        //private async Task<List<MasterDataKey>> ParseMasterDataExcel(IFormFile excelFile)
        //{
        //    var masterValueList = new List<MasterDataKey>();
        ...
        //            {
        //                var masterDataValue = new MasterDataKey();
        //                masterDataValue.RowKey = Guid.NewGuid().ToString();
