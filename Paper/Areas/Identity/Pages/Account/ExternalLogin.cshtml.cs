...
namespace Paper.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            var emailA = info.Principal.FindFirstValue(ClaimTypes.Email);
            if (info == null)
            {
            ...
            var Admin = await _userManager.FindByEmailAsync(emailA);
            ...
            else
            {
                ...
                if (!results.Succeeded)
                {
                    ...
                    return RedirectToPage("./Login", Input);
                }
                ...
                ModelState.AddModelError(string.Empty, results.ToString());
